...
const SearchForCarEngineItemCard = ({ item, index, onClick, activeIndx }) => {
    ...
    return (
        <TouchableOpacity style={[styles.container, { borderColor: index === activeIndx ? themeColors.primary : '#F9F9F9' }]} onPress={onClick} activeOpacity={0.6}>
            <View style={styles.item}>
                <CustomText body2 color='black'>{item.range}</CustomText>
            </View>
...
export default SearchForCarEngineItemCard
